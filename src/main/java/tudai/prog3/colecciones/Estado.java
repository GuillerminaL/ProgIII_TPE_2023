...
public class Estado {
     ...
     * Método add:
     *
     * Utilizado por el servicio a través del CSVReader como manera de almacenar la información de entrada.
     * a) Crea un objeto Túnel con la información recibida (origen, destino, etiqueta -km-) que es almacenado en la lista de túneles disponibles.
     * b) Almacena las estaciones origen y destino recibidas como entrada en un conjunto de estaciones a conectar
     * c) Actualiza el kilometraje total de los túneles disponibles
     *
     *
     * @param origen integer que representa la estacion origen
     * @param destino integer que representa de la estacion origen
     * @param etiqueta integer que representa la distancia en kilómetros desde la estación origen a la estación destino
     */
    ...
    public UnionFind getUnionFind() { return this.uf; }
    ...
    public void setUnionFind(UnionFind o) { this.uf = new UnionFind(o); }

    /**
     * Método addTunel:
     *
     * Inserta al inicio de la lista de túneles disponibles el objeto recibido por parámetro
     * Actualiza los kilómetros totales de la lista
     *
     * @param t tunel
     */
     ...
     * Método seleccionar:
     *
     * Agrega un túnel a la lista de túneles seleccionados
     * Actualiza los kilómetros totales de la lista
     *
     * @param t tunel
     */
     ...
     *
     * Utiliza Union Find para asociar dos elementos que aún no corresponden a un mismo conjunto,
     * referenciándolos al mismo padre
     *
     ...
     *
     * Utiliza Union Find para verificar si dos elementos integran un mismo conjunto o referencian al mismo padre
     *
     * @param a integer primer elemento
     * @param b integer segundo elemento
     *
     * @return true si dos elementos pertenecen a un mismo conjunto, false en caso contrario
     */
    public boolean estanConectadas(Integer a, Integer b) { return this.uf.sameSet(a, b); }

    /**
     * Método conexionCompleta:
     *
     * Utiliza Union Find para verificar si todos los elementos pertenecen a un mismo conjunto o
     * comparten una misma raíz
     *
     * @return  true si todos los elementos integran un mismo conjunto, false en caso contrario
     */
    public boolean conexionCompleta() { return this.uf.conexionCompleta(); }

    public boolean hayTunelesDisponibles() { return this.tuneles_disponibles.size() > 0; }
    ...
    public String tunelesSeleccionadosToString() { return this.tunelesToString(this.tuneles_seleccionados); }
